...
import { SiGit, SiNodedotjs, SiNpm, SiReact } from "react-icons/si";
...
const Services = () => {
  return (
    <div className="lg:flex w-full flex-wrap gap-6 m-auto py-10 ">
      {service.map((service, index) => (
        <div
          key={index}
          className="h-[250px] text-center w-[250px] md:w-[70%] lg:min-w-[200px] xl:w-[250px] box-content border-2 rounded-md m-auto my-5 p-5 flex flex-col items-center justify-evenly hover:border-[#7562E0] hover:-translate-y-1 hover:scale-105  duration-300"
        >
